...
#cohort_spine <- cohort_spine[academicyearofbirth %in% c(2003:2004, 2008:2009, 2011:2012)]
...
write.csv(surv_output_data, file = "chc_cumul/outputs/surv/km-plots-chc-subtypes-all-el-schemes-b2003-b2004-underlying-data.csv", row.names = F)

# output plots
tiff("chc_cumul/outputs/surv/km-plots-chc-subtypes-all-el-schemes-b2003-b2004.tiff",
...
tiff("chc_cumul/outputs/surv/km-plots-chc-subtypes-all-el-schemes-b2003-b2004-legend.tiff",
...
surv_output_data[, time_yrs := time / 12]
write.csv(surv_output_data, file = "chc_cumul/outputs/surv/km-plots-chc-subtypes-el-scheme-8-all-cohorts-underlying-data.csv", row.names = F)

# output plots
tiff("chc_cumul/outputs/surv/km-plots-chc-subtypes-el-scheme-8-all-cohorts.tiff",
     height = 12, width = 8, units = "in", res = 300)
arrange_ggsurvplots(p_list, nrow = 4, ncol = 2)
dev.off()

tiff("chc_cumul/outputs/surv/km-plots-chc-subtypes-el-scheme-8-all-cohorts-legend.tiff",
